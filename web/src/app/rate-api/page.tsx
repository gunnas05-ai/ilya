  ...
  return (
    <div>
      ...
      <div className="mb-4 relative">
        ...
        <input className="w-full glass-card pl-10 pr-4 py-2.5 text-kaptan-text placeholder-kaptan-muted" placeholder="Tarife ara..." value={search} onChange={e => setSearch(e.target.value)} />
      </div>
