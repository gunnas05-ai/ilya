...
const SCREEN_CONFIGS: Omit<ScreenConfig, 'options'>[] = [
  ...
  { name: 'TestCenter', component: TestCenterScreen, i18nKey: 'nav.testCenter' },
  { name: 'PermissionMatrix', component: PermissionMatrixScreen, i18nKey: 'nav.permissionMatrix' },
  { name: 'AuditLog', component: AuditLogScreen, i18nKey: 'nav.auditLog' },
  { name: 'SecurityCenter', component: SecurityCenterScreen, i18nKey: 'nav.securityCenter' },
  { name: 'SystemSettings', component: SystemSettingsScreen, i18nKey: 'nav.systemSettings' },
  ...
  { name: 'RoutePlanner', component: RoutePlannerScreen, i18nKey: 'nav.routePlanner' },
  { name: 'DocumentCenter', component: DocumentCenterScreen, i18nKey: 'nav.documentCenter' },
  ...
  { name: 'ChatRoom', component: ChatRoomScreen, i18nKey: 'nav.chatRoom' },
  { name: 'DuyuruYonetim', component: DuyuruYonetimScreen, i18nKey: 'nav.duyuruYonetim' },
  ...
  { name: 'DriverDashboard', component: DriverDashboardScreen, i18nKey: 'nav.driverDashboard' },
